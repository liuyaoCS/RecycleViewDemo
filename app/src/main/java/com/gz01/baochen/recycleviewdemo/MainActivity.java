package com.gz01.baochen.recycleviewdemo;
...
import com.gz01.baochen.recycleviewdemo.adapter.RecyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.setmOnItemClickListener(new RecyclerViewAdapter.OnItemClickListener() {
            ...
            public void onItemLongClickListener(View view, int position) {
                Toast.makeText(MainActivity.this,position+"+++++++++LongClick:",Toast.LENGTH_LONG).show();
